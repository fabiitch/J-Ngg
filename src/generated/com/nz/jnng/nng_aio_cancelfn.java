...
public final class nng_aio_cancelfn {
    ...
    private static final MethodHandle UP$MH = nng_h.upcallHandle(nng_aio_cancelfn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(nng_aio_cancelfn.Function fi, Arena arena) {
